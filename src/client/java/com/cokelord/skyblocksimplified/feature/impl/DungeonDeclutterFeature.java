...
public class DungeonDeclutterFeature extends Feature {
	...
	// Per user request ("We already have hide ability message. Hide this passive ability from healer: 'Used
	// Healing Circle!'"): a real ability-USE confirmation, sharing hideAbilityMessages' existing toggle
	// rather than a new one, per the user's own framing.
	private static final String USED_HEALING_CIRCLE_MESSAGE = "Used Healing Circle!";
	...
	public boolean shouldHideMessage(String text) {
		...
		if (hideAbilityMessages && (text.endsWith(ABILITY_AVAILABLE_SUFFIX) || text.equals(USED_HEALING_CIRCLE_MESSAGE))) return true;
