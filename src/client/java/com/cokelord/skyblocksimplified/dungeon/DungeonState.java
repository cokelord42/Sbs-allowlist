...
public final class DungeonState {
	...
	private static final Pattern TEAMMATE_PATTERN = Pattern.compile("^\\[(\\d+)] (?:\\[\\w+] )*(\\w+) .*?\\((\\w+)(?: (\\w+))*\\)$");
