...
public class SkyblockSimplifiedClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		FeatureRegistry.register(new com.cokelord.skyblocksimplified.feature.impl.FontImporterFeature());
		...
		FeatureRegistry.register(new com.cokelord.skyblocksimplified.feature.impl.HypixelModApiDependencyFeature());
	...
	private static void registerOdinDungeonFeatures() {
		...
		java.util.List.<com.cokelord.skyblocksimplified.feature.Feature>of(
			...
			doorHighlight, bloodCamp, mageBeam, leapMenu, mimic, starredMobHighlight, playerGlow, highlightPartyMembers, dungeonMap, dungeonScoreCalculator,
